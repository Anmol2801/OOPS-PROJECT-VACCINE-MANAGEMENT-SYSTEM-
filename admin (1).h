...
bool Admin::run_process(CitizenQueueList &cqueue)
{
	...
	cout<<"REGISTRATIONS CAN ONLY BE DONE FROM TODAY ITSELF"<<endl;
	cout<<"------------------------------------------------"<<endl;
	cout<<endl;
	cout<<"ENTER THE DAY FOR WHICH YOU WANT THE ALLOTMENT TO BE DONE : ";
	cin>>day1;
	cout<<"ENTER THE MONTH FOR WHICH YOU WANT THE ALLOTMENT TO BE DONE : ";
	cin>>month1;
	cout<<"ENTER THE YEAR FOR WHICH YOU WANT THE ALLOTMENT TO BE DONE : ";
	cin>>year1;
	string today1=date_string(day1, month1, year1);
	
	if (today1 == last_date) // This prevents multiple allotment rounds on the same day.
		return false;
	...
	for (int shots = 1; shots <= available_shots; shots++)
	{
		if (selected == nullptr)
			break;
		selected->slot_date = today1;
	...
	last_date = today1; // Modifies the last_date member to today's date
